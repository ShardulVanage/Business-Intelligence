...
const tiers = [
    {
        ...
        href: 'https://rzp.io/l/INuVDihOpI',
        priceMonthly: "₹1999",
        ndprice: "₹4999",
            ...
            <div className="relative overflow-hidden pt-32 pb-96 lg:pt-40">
                ...
                <div className="relative mx-auto max-w-7xl px-6 text-center lg:px-8">
                    <div className="mx-auto max-w-2xl lg:max-w-4xl">
                        <h2 className="text-4xl font-semibold leading-8 text-[#6a83bc] my-2">Pricing</h2>
                            ...
                            {tiers.map((tier) => (
                                <div key={tier.name} className="flex flex-col rounded-3xl bg-white shadow-xl ring-1 ring-black/10">
                                    <div className="p-8 sm:px-10 sm:pt-9">
                                        <h3 className="text-lg font-semibold leading-8 tracking-tight text-[#4b6cb7]" id={tier.id}>
                                            {tier.name}
                                        </h3>
                                        <div className="mt-4 flex items-baseline text-4xl sm:text-5xl font-bold tracking-tight text-gray-900">
                                            {tier.priceMonthly}

                                            <span className='pl-2 text-2xl sm:text-3xl text-[#4b6cb7]'><del >{tier.ndprice}</del><span className='text-lg text-black pl-2'>60%</span><span className=' pl-0.5 text-lg text-black '>Off</span> </span>
                                        </div>
                                    ...
                                    <div className="flex flex-1 flex-col p-2 pt-0">
                                        <div className="flex flex-1 flex-col justify-between rounded-2xl bg-gray-50 p-6 sm:p-8">
                                                ...
                                                {tier.features.map((feature) => (
                                                    <li key={feature} className="flex items-start">
                                                        <div className="flex-shrink-0">
                                                            <CheckIcon className="h-6 w-6 text-[#28385a]" aria-hidden="true" />
                                                        </div>
                                            ...
                                            <div className="mt-8">
                                                <a
                                                    href={tier.href}
                                                    className="inline-block w-full rounded-lg bg-[#3f5c96] px-4 py-2.5 text-center text-sm font-semibold leading-5 text-white shadow-md hover:bg-[#4b6cb7]"
