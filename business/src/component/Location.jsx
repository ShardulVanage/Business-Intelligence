    ...
    return (
        <motion.div  {...slideAnimation("left")}>
            ...
            <Card className="mt-6 w-96 p-4 m-4 mb-16">
                <CardBody>
                    <MapPinIcon className="text-[#4b6cb7] w-12 h-12 mb-4" />
            ...
            <a href="mailto:contact@zepanalytics.com">
                <Card className="mt-6 w-96 p-4 m-4 mb-16">
                    <CardBody>
                        <EnvelopeIcon className="text-[#4b6cb7] w-12 h-12 mb-4" />
                        <Typography variant="h5" color="blue-gray" className="mb-2">
                            Email Us
                        </Typography>
                        <Typography>
            ...
            <Card className="mt-6 w-96 p-4 m-4 mb-16">
                <CardBody>
                    <PhoneIcon className="text-[#4b6cb7] w-12 h-12 mb-4" />
                    <Typography variant="h5" color="blue-gray" className="mb-2">
                        Phone
                    </Typography>
                    <Typography>
            ...
            <a href="https://wa.me/+918237040802">
                <Card className="mt-6 w-96 p-4 m-4 mb-16">
                    <CardBody>
                        <BsWhatsapp className="text-[#4b6cb7] w-12 h-12 mb-4" />
                        <Typography variant="h5" color="blue-gray" className="mb-2">
                            WhatsApp
                        </Typography>
                        <Typography>
